...
// Error code to message mappings
    ...
    max_idle = flag.Int("max_idle", 500, "Max idle redis connections")
...
func handleAnnounce(c *echo.Context) {
    ...
    r.Send("HMSET", "ip", ann.IPv4.String(), "port", ann.Port, "left", ann.Left, "first_announce", peer.AnnounceFirst, "last_announce", peer.AnnounceLast, "speed_up", peer.SpeedUP, "speed_dn", peer.SpeedDN)
